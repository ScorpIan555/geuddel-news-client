                        ...
                        <div className="card card-sm">
                            ...
                            <li className="list-group-item">
                                ...
                                <div className="media-body">
                                    ...
                                    <ul className="list-inline">
                                        <li className="list-inline-item"><i className="icon-heart" /> 221</li>
                                        <li className="list-inline-item"><i className="icon-message" /> 14</li>
                                    </ul>
                                    </div>
                                </div>
                                </div>
                            ...
                            <li className="list-group-item">
                                ...
                                <div className="media-body">
                                    ...
                                    <div className="text-small">
                                    <ul className="list-inline">
                                        <li className="list-inline-item"><i className="icon-heart" /> 90</li>
                                        <li className="list-inline-item"><i className="icon-message" /> 34</li>
                                    </ul>
                                    </div>
                                </div>
                                </div>
                            ...
                            <li className="list-group-item">
                                ...
                                <div className="media-body">
                                    ...
                                    <div className="text-small">
                                    <ul className="list-inline">
                                        <li className="list-inline-item"><i className="icon-heart" /> 84</li>
                                        <li className="list-inline-item"><i className="icon-message" /> 25</li>
                                    </ul>
                                    </div>
                                </div>
                                </div>
                            ...
                            <li className="list-group-item">
                                ...
                                <div className="media-body">
                                    ...
                                    <div className="text-small">
                                    <ul className="list-inline">
                                        <li className="list-inline-item"><i className="icon-heart" /> 253</li>
                                        <li className="list-inline-item"><i className="icon-message" /> 19</li>
                                    </ul>
                                    </div>
                                </div>
                                </div>
                            ...
                            <li className="list-group-item">
                                ...
                                <div className="media-body">
                                    ...
                                    <ul className="list-inline">
                                        <li className="list-inline-item"><i className="icon-heart" /> 84</li>
                                        <li className="list-inline-item"><i className="icon-message" /> 21</li>
                                    </ul>
                                    </div>
                                </div>
                                </div>
                            ...
                            <li className="list-group-item">
                                ...
                                <div className="media-body">
                                    ...
                                    <div className="text-small">
                                    <ul className="list-inline">
                                        <li className="list-inline-item"><i className="icon-heart" /> 373</li>
                                        <li className="list-inline-item"><i className="icon-message" /> 62</li>
                                    </ul>
                                    </div>
                                </div>
                                </div>
